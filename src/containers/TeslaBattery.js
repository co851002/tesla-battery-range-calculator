  ...
  render() {
    ...
    return (
      <form className="tesla-battery">
        ...
        <div className="tesla-controls row">
          <div className="tesla-ac-container col-12">
            <TeslaClimate
          ...
          <div className="tesla-speed-container col-3">
            <TeslaCounter
              currentValue={this.state.config.speed}
          ...
          <div className="tesla-climate-container col-3">
              <TeslaCounter
                currentValue={this.state.config.temperature}
          ...
          <div className="tesla-wheels-container col-6">
            <TeslaWheels
